...
use crate::rig_agent_v2::tools::mcp_adapter::{create_mcp_tool_functions, McpToolAdapter};
use serde_json::Value;
use std::sync::Arc;
use tauri::{AppHandle, Emitter, State};

/// Initialize MCP tools in rig_agent_v2
#[tauri::command]
#[specta::specta]
pub async fn initialize_mcp_tools(
    ...
    // Create tool functions for rig_agent_v2 integration
...
pub async fn refresh_mcp_tools_command(
    ...
    log::info!("Refreshing MCP tools in rig_agent_v2");
    ...
    if let Err(e) = app.emit(
        "rig_agent_v2:mcp_tools_refreshed",
        serde_json::json!({
            "active_servers": active_servers,
