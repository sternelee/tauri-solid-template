...
pub async fn initialize_ai_system(
    ...
    match super::AgentManager::new(config).await {
        Ok(agent_manager) => {
            ...
            log::info!(
                "AI system initialized successfully with provider: {:?}",
...
#[tauri::command]
#[specta::specta]
pub async fn get_ai_system_info(_app: AppHandle) -> std::result::Result<Value, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn get_ai_capabilities(_app: AppHandle) -> std::result::Result<Value, String> {
