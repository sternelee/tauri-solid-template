...
impl ChatCapability {
    ...
    pub async fn chat(
        ...
        let start_event = crate::rig_agent::events::types::AgentEvent::new(
        ...
        let _ = crate::rig_agent::events::EventEmitter::emit_global(start_event).await;
        ...
        let completion_event = crate::rig_agent::events::types::AgentEvent::new(
            crate::rig_agent::events::types::EventType::ChatCompleted,
    ...
    pub async fn chat_stream(
        ...
        let start_event = crate::rig_agent::events::types::AgentEvent::new(
            crate::rig_agent::events::types::EventType::StreamStarted,
