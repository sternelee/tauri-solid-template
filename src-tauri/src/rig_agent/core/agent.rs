...
impl UnifiedAgent {
    ...
    pub async fn chat(&self, request: super::ChatRequest) -> Result<super::ChatResponse> {
        ...
        match result {
            Ok(response) => {
                ...
                let message = super::ChatMessage::new(super::MessageRole::Assistant, content);
            ...
            Err(e) => {
                ...
                Err(super::AgentError::ChatError(format!(
    ...
    pub async fn generate_embeddings(&self, texts: Vec<String>) -> Result<Vec<Vec<f32>>> {
        ...
        match &self.client {
            DynamicClient::OpenAI(client) => {
                ...
                for text in &texts {
                    ...
                    match client.embeddings::<&str>(text).build().await {
                        ...
                        Err(e) => {
                            return Err(super::AgentError::EmbeddingError(format!(
            ...
            _ => Err(super::AgentError::EmbeddingError(
